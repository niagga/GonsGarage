...
func (m *mockFiscalRepo) HasProtectedFiscalHistory(ctx context.Context, id uuid.UUID) (bool, error) {
	return false, nil
}
func (m *mockFiscalRepo) CreateDraft(ctx context.Context, input ports.CreateDraftInput) (*ports.FiscalDocumentAggregate, error) {
	return nil, nil
}
func (m *mockFiscalRepo) UpdateDraft(ctx context.Context, id uuid.UUID, v int64, s ports.FiscalSnapshotRecord) (*ports.FiscalDocumentAggregate, error) {
	return nil, nil
}
func (m *mockFiscalRepo) GetCurrentIntent(ctx context.Context, id uuid.UUID, slot string) (*ports.FiscalDocumentAggregate, error) {
	return nil, nil
}
func (m *mockFiscalRepo) DeleteDraft(ctx context.Context, id uuid.UUID, v int64) error { return nil }
func (m *mockFiscalRepo) FinalizeDraft(ctx context.Context, cmd ports.FinalizeDraftCommand) (*ports.FinalizeDraftResult, error) {
	return nil, nil
}
...
func (m *mockFiscalProvider) VerifyConnection(ctx context.Context, req ports.FiscalVerifyConnectionRequest) (ports.FiscalVerifyConnectionResult, error) {
	return ports.FiscalVerifyConnectionResult{}, nil
}
func (m *mockFiscalProvider) Reconcile(ctx context.Context, req ports.FiscalReconcileRequest) (ports.FiscalReconcileResult, error) {
	return ports.FiscalReconcileResult{}, nil
}
func (m *mockFiscalProvider) Void(ctx context.Context, req ports.FiscalVoidRequest) (ports.FiscalVoidResult, error) {
	return ports.FiscalVoidResult{}, nil
}
func (m *mockFiscalProvider) FetchArtifact(ctx context.Context, req ports.FiscalFetchArtifactRequest) (ports.FiscalFetchArtifactResult, error) {
